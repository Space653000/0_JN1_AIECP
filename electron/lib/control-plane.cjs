...
class ControlPlane {
  ...
  async createMission({goal,done,sourceRoot,workspaceId=null,context='',maxTasks=8,maxIterations=5,maxConcurrency=2,maxTurns=null,maxFailedAttempts=null,maxNoProgressAttempts=2,maxWallClockMs=null,maxPatchBytes=null,maxChangedFiles=null,checkpointEvery=1,autoStart=true,autoResume=true,delivery=false,githubRepo=null,providers={},models={},providerApprovals={}}){
