...
const matrix={
  ...
  'R2.1':{classes:['TESTED'],evidence:['tests/control-plane.test.cjs','electron/lib/harness.cjs','tests/harness-bounds.test.cjs']},
  ...
  'R2.5':{classes:['TESTED'],evidence:['tests/harness.test.cjs','tests/control-plane.test.cjs','tests/harness-bounds.test.cjs','tests/autonomy.test.cjs','electron/lib/harness.cjs']},
  ...
  'R3.2':{classes:['TESTED'],evidence:['tests/provider-router.test.cjs','scripts/provider-environment-verify.cjs','tests/provider-environment-workflow.test.cjs','electron/lib/execution-contract.cjs','tests/execution-contract.test.cjs']},
