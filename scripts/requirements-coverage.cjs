...
const matrix={
  ...
  'R2.3':{classes:['TESTED'],evidence:['tests/autonomy.test.cjs']},
  'R2.4':{classes:['TESTED'],evidence:['tests/autonomy.test.cjs','tests/harness.test.cjs']},
  'R2.5':{classes:['TESTED'],evidence:['tests/harness.test.cjs','tests/control-plane.test.cjs']},
  ...
  'R3.2':{classes:['TESTED'],evidence:['tests/provider-router.test.cjs']},
