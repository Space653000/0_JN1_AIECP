...
const matrix={
  ...
  '07_INSTALL_RELEASE.md':{type:'FUNCTIONAL',evidence:['.github/workflows/ci.yml','.github/workflows/release.yml','.github/workflows/store-package.yml','tests/release-workflow.test.cjs']},
  ...
  '15_SELF_EVOLUTION_PRIVATE_UPDATE_AGENT_INTEROP.md':{type:'FUNCTIONAL',evidence:['electron/lib/update-state.cjs','electron/lib/backup-manager.cjs','tests/update-state.test.cjs','tests/backup-manager.test.cjs','.github/workflows/release.yml']},
