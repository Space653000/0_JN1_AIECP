...
const matrix={
  ...
  '01_UX_UI_SPEC.md':{type:'FUNCTIONAL',evidence:['ui/index.html','ui/app.js','electron/lib/workspace-policy.cjs','electron/lib/adapter-security-audit.cjs','tests/i18n-accessibility.test.cjs','tests/human-controls.test.cjs','tests/workspace-policy.test.cjs']},
  ...
  '03_PROVIDER_ROUTER.md':{type:'FUNCTIONAL',evidence:['electron/lib/provider-router.cjs','electron/lib/pega-provider.cjs','electron/lib/codex-worker-runtime.cjs','electron/lib/worker-registry.cjs','tests/provider-router.test.cjs','tests/provider-router.e2e.test.cjs','tests/provider-network.e2e.test.cjs','tests/provider-integration.test.cjs','tests/worker-registry.test.cjs']},
  '04_SECURITY_AND_POLICY.md':{type:'FUNCTIONAL',evidence:['electron/lib/security-policy.cjs','electron/lib/workspace-policy.cjs','electron/lib/adapter-security-audit.cjs','electron/lib/redaction.cjs','tests/security-recovery-matrix.test.cjs','tests/redaction.test.cjs','tests/workspace-policy.test.cjs']},
  '05_GITHUB_MULTI_REPO.md':{type:'FUNCTIONAL',evidence:['electron/lib/resource-manager.cjs','electron/lib/delivery.cjs','electron/lib/ci-monitor.cjs','electron/lib/control-plane.cjs','tests/canonical-loop.e2e.test.cjs','tests/control-plane.test.cjs','tests/worker-registry.test.cjs']},
  ...
  '12_DATA_MODEL.md':{type:'FUNCTIONAL',evidence:['electron/lib/control-plane.cjs','electron/lib/worker-registry.cjs','electron/lib/state-migration.cjs','electron/lib/local-data-manager.cjs','tests/worker-registry.test.cjs','tests/state-migration.test.cjs','tests/event-projection.test.cjs','tests/local-data-manager.test.cjs']},
  '13_TRIPLE_AUDIT.md':{type:'HISTORICAL',evidence:['Blueprint/23_IMPLEMENTATION_STATUS.md','Blueprint/13_TRIPLE_AUDIT.md']},
  ...
  '17_V0_2_TRIPLE_AUDIT.md':{type:'HISTORICAL',evidence:['Blueprint/23_IMPLEMENTATION_STATUS.md','Blueprint/17_V0_2_TRIPLE_AUDIT.md']},
  '18_BOUNDED_AUTONOMOUS_EXECUTION.md':{type:'FUNCTIONAL',evidence:['electron/lib/autonomy.cjs','electron/lib/codex-worker-runtime.cjs','electron/lib/worker-registry.cjs','tests/autonomy.test.cjs','tests/worker-registry.test.cjs','tests/human-controls.test.cjs']},
  '19_V0_3_TRIPLE_AUDIT.md':{type:'HISTORICAL',evidence:['Blueprint/23_IMPLEMENTATION_STATUS.md','Blueprint/19_V0_3_TRIPLE_AUDIT.md']},
  '20_HARNESS_ENGINEERING_MULTI_AGENT_LOOP.md':{type:'FUNCTIONAL',evidence:['electron/lib/control-plane.cjs','electron/lib/harness.cjs','electron/lib/worker-registry.cjs','electron/lib/accepted-evidence.cjs','tests/control-plane.test.cjs','tests/worker-registry.test.cjs','tests/canonical-loop.e2e.test.cjs','tests/harness-bounds.test.cjs','tests/accepted-evidence.test.cjs']},
  '21_AGENT_ROLES_AND_HANDOFF_PROTOCOL.md':{type:'FUNCTIONAL',evidence:['electron/lib/provider-router.cjs','electron/lib/worker-registry.cjs','electron/lib/codex-worker-runtime.cjs','electron/lib/harness.cjs','tests/provider-integration.test.cjs','tests/worker-registry.test.cjs']},
  '22_DASHBOARD_QUEUE_AND_EVENT_ARCHITECTURE.md':{type:'FUNCTIONAL',evidence:['electron/lib/event-projection.cjs','electron/lib/control-plane.cjs','ui/harness-console.js','tests/event-projection.test.cjs','tests/i18n-accessibility.test.cjs','tests/dashboard-acceptance.test.cjs','tests/provider-integration.test.cjs']},
